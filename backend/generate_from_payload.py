...
ok_path = Path(__file__).parent / 'generate_ok.txt'
log_path = Path(__file__).parent / 'generate_run_log.txt'
try:
    ok_path.write_text('starting\n', encoding='utf-8')
    import matplotlib
    matplotlib.use('Agg')
